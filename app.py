...
st.set_page_config(page_title="Healthy Eating And Well-Being App")

st.header("Healthy Eating And Well-Being App")
...
...
...
Finally, mention whether the food is healthy or not and provide the percentage split of the ratio of carbohydrates, fats, fibers, sugar, and other dietary components.
"""
